...
Plex has no external dependencies and can be used right away after compilation. See [Versions](/docs/versions) to see what the compatibility for Plex is. You also must be running Java 21 on the server itself.
